...
const CalificacionConsumidor = ({navigation}) => {
  ...
  const submitCalificacion = () => {
    // Aquí puedes manejar la lógica para enviar la calificación y el comentario al servidor o a donde sea necesario
    console.log('Calificación:', calificacion);
    console.log('Comentario:', comentario);

    navigation.goBack(); // Volvemos a la vista anterior después de enviar la calificación
  };
    ...
    <View style={styles.container}>
      ...
      <View style={styles.content}>
        <View style={styles.card}>
          <Text style={styles.cardHeader}>Califica al Agricultor</Text>
